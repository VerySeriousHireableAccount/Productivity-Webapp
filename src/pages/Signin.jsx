...
export default function Signin() {
    const { setUsername, setEmail, setPassword } = useStateContext();
        ...
        <div className='bg-gray-800 flex flex-col justify-center'>
            <form className='max-w-[400px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8'>
                ...
                <div className='flex flex-col text-gray-400 py-2'>
                    ...
                    <input onChange={e => setInputName(e.target.value)} className='rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="text"  required="required" />
                </div>
                <div className='flex flex-col text-gray-400 py-2'>
                    <label>Email</label>
                    <input onChange={e => setInputEmail(e.target.value)} className='p-2 rounded-lg bg-gray-700 mt-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="email"  required="required" />
                </div>
                <div className='flex flex-col text-gray-400 py-2'>
